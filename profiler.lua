...
local function display_profiles()
	...
	for prof in all(profiles) do
		...
		-- Check if profile name starts with spaces (indented sub-profile)
		local color = prof.name:sub(1,1) == " " and 12 or 7  -- 12 = blue, 7 = white
		print_shadow(to_print,1,profiler_y_offset+i*9,color)
		i = i+1
	end
